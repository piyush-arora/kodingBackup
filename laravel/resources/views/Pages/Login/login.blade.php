...
<head>
  ...
  <title>Hack In Cloud | Log in</title>
...
<body class="hold-transition login-page">
  ...
  <!-- /.login-logo -->
    <div class="login-box-body">
        <p class="login-box-msg">Please Register Using</p>
    ...
    <div class="social-auth-links text-center">
        ...
        --> 
            ...
            <a href="fblogin" class="btn btn-block btn-social btn-facebook btn-flat"><i class="fa fa-facebook"></i> Sign in using
                Facebook
            </a>
            
            
           
            <a href="gologin" class="btn btn-block btn-social btn-google btn-flat"><i class="fa fa-google-plus"></i> Sign in using
                Google+
            </a>
...
<!-- jQuery 2.1.4 -->
<script src="Dashboard/jQuery/jQuery-2.1.4.min.js"></script>
<!-- Bootstrap 3.3.5 -->
